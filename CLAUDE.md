...
- **The Insights report is the consolidation candidate for PR (and
  ...
  **No cache bump** -- `meta.agents` already carried the resolved selection,
  ...
  (deterministic per `hashAgents_` key; insights:v15 unchanged). The QCD
  ...
  **Chart consolidation (seq #1, insights:v15):** the 12-mo team-trend
  ...
  **Per-agent cards (seq #3, redesigned in the post-deploy pass):** each
  ...
  `insights:v15` already makes a fresh re-generate fast too). The team
