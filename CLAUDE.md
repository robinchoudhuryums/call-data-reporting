...
- **The Insights report is the consolidation candidate for PR (and
  ...
  **Chart consolidation (seq #1, insights:v11):** the 12-mo team-trend
  ...
  **Per-agent cards (seq #3, redesigned in the post-deploy pass):** each
  ...
  `insights:v11` already makes a fresh re-generate fast too). The team
