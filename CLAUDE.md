...
- **CSV exports must neutralize formula injection.** Agent names
  ...
  (`exportTableCsv_`'s `csvEscape`) and the Insights CSV
  (`insDownloadCsv_`). Any new CSV cell writer must call `csvSafeCell_`
