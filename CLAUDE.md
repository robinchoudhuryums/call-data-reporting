...
- **Insights period slider, trend-at-bottom, and the Insights<->My-Department
  ...
  and a CSR-only "Transfer %" tile from the `csrTransfer` block -- summary:v14.) Insights carries a header **"My Department ->"** button and
