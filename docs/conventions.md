...
- Mean columns (ATT, Avg Abd Wait, CSR Avg Abd Wait) take a simple mean
  of the NONZERO per-agent rows displayed (`avgNonzero_`; introduced in the summary cache's v11 bump — current prefix summary:v17).
...
|---|---|---|
| `Data.gs` (main table) | `summary:vN:` | `v17` |
